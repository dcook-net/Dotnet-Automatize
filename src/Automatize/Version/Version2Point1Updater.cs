namespace Automatize.Version
{
    public class Version2Point1Updater : IDotNetVersionUpdater
    {
        ...
        public string LinuxSdkImageVersion => "dotnet:2.1.505-sdk";
        public string AlpineSdkImageVersion => "dotnet:2.1.505-sdk-alpine3.9";
        public string LinuxRuntimeImageVersion => "dotnet:2.1.9-aspnetcore-runtime";
        public string AlpineRuntimeImageVersion => "dotnet:2.1.9-aspnetcore-runtime-alpine3.9";
