namespace Automatize.Version
{
    public class Version2Point2Updater : IDotNetVersionUpdater
    {
        ...
        public string LinuxSdkImageVersion => "dotnet:2.2.104-sdk";
        public string AlpineSdkImageVersion => "dotnet:2.2.104-sdk-alpine3.8";
        public string LinuxRuntimeImageVersion => "dotnet:2.2.2-aspnetcore-runtime";
        public string AlpineRuntimeImageVersion => "dotnet:2.2.2-aspnetcore-runtime-alpine3.8";
