...
namespace Automatize.Tests
{
    ...
    public class Version2Point2UpdaterTests : VersionUpdaterTestBase
    {
        ...
        [TestCase("SampleProjectFile-DontUpdateCommonLibVersions-v2.1.csproj", "ExpectedResult-DontUpdateCommonLibVersions-v2.2.2.csproj")]
        [TestCase("SampleProjectFile-v2.1.csproj", "ExpectedProjFile-v2.2.2.csproj")]
        [TestCase("NetStandardXmlFile.csproj", "ExpectedNetStandardXmlFile.csproj")]
        [TestCase("LibProjectFile-v2.1.csproj", "ExpectedLibProjFile-v2.2.2.csproj")]
        ...
        [TestCase("DockerFile_Sample-v2.1", "DockerFile_Expected-v2.2.2", false)]
        [TestCase("DockerFile_Sample-v2.1", "DockerFile_Linux_Expected-v2.2.2", true)]
        ...
        [TestCase("Sample.env", "Expected-v2.2.2.env", false)]
        [TestCase("Sample.env", "Expected_Linux-v2.2.2.env", true)]
